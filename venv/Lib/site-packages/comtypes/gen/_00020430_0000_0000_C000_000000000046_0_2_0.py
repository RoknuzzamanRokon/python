...
<<<<<<< HEAD
__all__ = [
    'FONTBOLD', 'OLE_YSIZE_PIXELS', 'OLE_TRISTATE', 'Monochrome',
    'Unchecked', 'OLE_YSIZE_HIMETRIC', 'FONTNAME',
    'FONTSTRIKETHROUGH', 'VgaColor', 'OLE_YSIZE_CONTAINER',
    'FONTITALIC', 'Gray', 'StdFont', 'IFont', 'OLE_XPOS_PIXELS',
    'FONTSIZE', 'OLE_XSIZE_PIXELS', 'OLE_XPOS_CONTAINER', 'Color',
    'OLE_YPOS_CONTAINER', 'Checked', 'StdPicture', 'OLE_COLOR',
    'OLE_ENABLEDEFAULTBOOL', 'OLE_XSIZE_CONTAINER',
    'OLE_OPTEXCLUSIVE', 'OLE_HANDLE', 'OLE_YPOS_PIXELS', 'IFontDisp',
    'OLE_XPOS_HIMETRIC', 'Font', 'IPictureDisp', 'Default',
    'LoadPictureConstants', 'OLE_CANCELBOOL', 'Picture',
    'OLE_XSIZE_HIMETRIC', 'FONTUNDERSCORE', 'FontEvents',
...
__all__ = [
    'FONTBOLD', 'OLE_YPOS_CONTAINER', 'Picture',
    'OLE_ENABLEDEFAULTBOOL', 'OLE_HANDLE', 'Monochrome', 'Checked',
    'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_PIXELS', 'OLE_XSIZE_CONTAINER',
    'FONTITALIC', 'OLE_XPOS_HIMETRIC', 'OLE_YSIZE_HIMETRIC',
    'VgaColor', 'FONTUNDERSCORE', 'Color', 'IFontDisp', 'StdPicture',
    'OLE_COLOR', 'FONTSTRIKETHROUGH', 'IPicture',
    'OLE_XPOS_CONTAINER', 'OLE_YPOS_HIMETRIC', 'FONTSIZE',
    'OLE_XSIZE_HIMETRIC', 'FONTNAME', 'Default', 'Font',
    'OLE_XPOS_PIXELS', 'FontEvents', 'OLE_CANCELBOOL', 'Unchecked',
    'IPictureDisp', 'OLE_OPTEXCLUSIVE', 'IFontEventsDisp', 'StdFont',
    'OLE_YSIZE_PIXELS', 'OLE_YPOS_PIXELS', 'LoadPictureConstants',
    'OLE_TRISTATE', 'Gray', 'IFont'
>>>>>>> roko1
]
