...
__all__ = [
    'ISpeechMMSysAudio', 'SP_VISEME_20', 'ISpeechGrammarRules',
    'SpeechGrammarTagWildcard', 'DISPID_SLWsItem',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SRCPause',
    'ISpeechGrammarRuleStateTransition', 'SP_VISEME_11',
    'SpeechVoiceEvents', 'DISPID_SOTCId', 'SDA_No_Trailing_Space',
    'SREStateChange', 'SPCS_ENABLED', 'DISPID_SDKEnumKeys',
    'DISPID_SGRSTransitions', 'DISPID_SPEsCount',
    'DISPID_SpeechRecoResult2', 'DISPID_SPIAudioStreamPosition',
    'ISpeechDataKey', 'DISPID_SVPause', 'SP_VISEME_2',
    'DISPID_SPPsCount', 'DISPID_SVSInputSentenceLength',
    'ISpeechCustomStream', 'SpeechRecoEvents', 'SRAImport',
    'eLEXTYPE_PRIVATE8', 'SAFT16kHz8BitStereo',
    'SGDSActiveUserDelimited', 'DISPID_SpeechMemoryStream',
    'ISpeechPhraseAlternate', 'SLTUser', 'SVEViseme',
    'SpSharedRecoContext', 'SP_VISEME_15', 'SPEI_TTS_AUDIO_LEVEL',
    'SPFM_NUM_MODES', 'SSFMOpenReadWrite', 'SAFTGSM610_8kHzMono',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SADefaultFormat', 'DISPID_SASetState', 'ISpShortcut',
    'IEnumString', 'DISPID_SRCResume', 'SFTSREngine', 'SPAS_RUN',
    'DISPID_SRCRequestedUIType', 'SpeechMicTraining',
    'SpObjectTokenCategory', 'SP_VISEME_21', 'SpMMAudioEnum',
    'SPEI_SR_AUDIO_LEVEL', 'SRADynamic', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SpeechAudioBufferInfo', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCState', 'SREStreamStart', 'STSF_LocalAppData',
    'SpeechAudioFormatGUIDWave', 'eLEXTYPE_PRIVATE5',
    'ISpeechLexicon', 'DISPID_SPEsItem', 'SP_VISEME_10',
    'SWPUnknownWordUnpronounceable', 'DISPID_SPIGetText',
    'DISPID_SRDisplayUI', 'SASClosed', 'Speech_Max_Pron_Length',
    'ISpeechObjectToken', 'SVF_None', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpeechPhoneConverter', 'DISPID_SASCurrentDevicePosition',
    'SPEI_RESERVED5', 'SpPhoneConverter', 'DISPID_SOTCreateInstance',
    'SPSNoun', 'DISPID_SGRsCount',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SECHighConfidence', 'SINone', 'DISPID_SOTGetStorageFileName',
    'SAFTCCITT_ALaw_22kHzStereo', 'SPPHRASEELEMENT',
    'SDA_Two_Trailing_Spaces', 'SPEI_START_SR_STREAM',
    'SpeechLexiconType', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPEPronunciation', 'SPAUDIOBUFFERINFO', 'DISPID_SRGId',
    'DISPID_SpeechGrammarRule', 'eLEXTYPE_RESERVED8', 'SPFM_CREATE',
    'SpeechVisemeFeature', 'eLEXTYPE_PRIVATE10', 'ISpEventSource',
    'SpeechRetainedAudioOptions', 'eLEXTYPE_RESERVED6', 'SPSFunction',
    ...
    'SpeechDisplayAttributes', 'SAFT24kHz8BitStereo',
    'SPRECORESULTTIMES', 'ISpeechRecoResultDispatch',
    'SAFT11kHz16BitMono', 'DISPID_SRCEPropertyStringChange', 'SVP_21',
    'SpeechUserTraining', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRGCmdLoadFromObject', 'SAFTADPCM_44kHzMono',
    'DISPID_SGRSTPropertyValue', 'eWORDTYPE_ADDED',
    'DISPID_SLAddPronunciation', 'SPSHT_Unknown',
    'DISPID_SPIAudioSizeBytes', 'SpeechLoadOption',
    'DISPID_SRCEventInterests', 'SPCS_DISABLED', 'SREAudioLevel',
    'SDTProperty', 'SpeechPropertyLowConfidenceThreshold',
    'SPEI_SOUND_START', 'SPEI_PROPERTY_NUM_CHANGE',
    'SpeechAllElements', 'SpWaveFormatEx', 'DISPID_SLWLangId',
    'DISPID_SRCRetainedAudio', 'DISPID_SDKEnumValues',
    'DISPID_SRCRecognizer', 'SPEI_WORD_BOUNDARY', 'tagSPPROPERTYINFO',
    'SPPS_Interjection', 'WAVEFORMATEX', 'SpMMAudioIn',
    'SpUnCompressedLexicon', 'DISPID_SpeechLexiconPronunciation',
    'SPEI_RESERVED6', 'SAFTADPCM_11kHzStereo', 'ISequentialStream',
    'SPCT_COMMAND', 'SAFTADPCM_11kHzMono', 'SpStreamFormatConverter',
    'ISpeechBaseStream', 'ISpeechGrammarRuleState',
    'SPEVENTSOURCEINFO', 'SAFTGSM610_44kHzMono',
    'SpeechCategoryRecoProfiles', 'SP_VISEME_12', 'DISPID_SPIRule',
    'SPPS_Noun', 'SDTRule', 'DISPID_SPIEnginePrivateData',
    'SpeechRuleState', 'SPEI_TTS_PRIVATE',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_PRIVATE3',
    'DISPID_SpeechCustomStream', 'SAFTNonStandardFormat',
    'SRERecognition', 'SVSFNLPMask', 'SPINTERFERENCE_TOOFAST',
    'SSFMOpenForRead', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPIElements', 'DISPID_SPPValue',
    'DISPID_SVSCurrentStreamNumber', 'ISpObjectWithToken',
    'SSTTWildcard', 'DISPID_SGRSAddWordTransition',
    'DISPID_SRRSaveToMemory', 'STCInprocServer',
    'ISpeechRecognizerStatus', 'SpeechPropertyResourceUsage',
    'SFTInput', 'DISPID_SRSetPropertyNumber', 'SRSInactiveWithPurge',
    'SpeechDiscardType', 'SAFT32kHz16BitMono',
    'ISpeechRecoResultTimes', 'SPDKL_LocalMachine',
    'DISPID_SAFSetWaveFormatEx', 'SPINTERFERENCE_NOISE',
    'SREInterference', 'DISPID_SpeechDataKey',
    'SpeechAudioFormatType', 'SPSUnknown', 'SASStop',
    'ISpeechWaveFormatEx', 'SRCS_Enabled', 'DISPID_SGRName',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SpeechPhraseAlternates',
    'SPEI_SR_BOOKMARK', 'ISpPhoneConverter', 'ISpVoice',
    'DISPID_SVEStreamStart', 'DISPID_SDKDeleteValue', 'SVP_14',
    'DISPID_SPERetainedSizeBytes',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPFILEMODE',
    'SPEI_SOUND_END', 'SPSERIALIZEDRESULT', 'DISPID_SRState',
    'SpeechBookmarkOptions', 'SPEI_VISEME', 'SDTReplacement',
    'SPVPRI_ALERT', 'STCLocalServer', 'SAFTADPCM_8kHzMono',
    'SP_VISEME_13', 'DISPID_SRSCurrentStreamNumber',
    'SPPHRASEPROPERTY', 'SPRS_ACTIVE', 'DISPID_SVSPhonemeId',
    'ISpDataKey', 'DISPID_SRGetPropertyString', 'ISpeechGrammarRule',
    'SAFT12kHz16BitMono', 'DISPID_SRCERequestUI', 'SDTDisplayText',
    'DISPID_SOTCGetDataKey', 'DISPID_SWFESamplesPerSec',
    'SpeechPropertyAdaptationOn', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRsCommit', 'DISPID_SpeechGrammarRuleState',
    'DISPIDSPTSI', 'DISPID_SVStatus', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'ISpMMSysAudio', 'DISPID_SRCEEndStream', 'SECFEmulateResult',
    'DISPID_SPIReplacements', 'DISPID_SPRuleName', 'SREStreamEnd',
    'SpeechWordType', 'DISPID_SRRTStreamTime', 'SREHypothesis',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRCERecognition',
    'SPPS_Modifier', 'DISPID_SRGDictationLoad', 'DISPID_SGRSTWeight',
    'DISPID_SpeechPhraseAlternate', 'SAFT24kHz16BitStereo',
    'SVEAllEvents', 'DISPID_SGRAttributes', 'DISPID_SVEventInterests',
    ...
    'DISPID_SVRate', 'SPADAPTATIONRELEVANCE', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechLexiconWord', 'SDTLexicalForm', 'SGRSTTWildcard',
    'DISPID_SPAsItem', 'SVP_4', 'SGRSTTDictation',
    'DISPID_SGRSTs_NewEnum', 'SPGRAMMARWORDTYPE', 'SPEI_PHRASE_START',
    'SAFT8kHz16BitMono', 'eLEXTYPE_PRIVATE9', 'SPRS_INACTIVE',
    'SVP_10', 'ISpeechFileStream', 'DISPID_SGRSRule',
    'DISPID_SVSpeakStream', 'ISpeechAudioStatus', 'DISPID_SVEPhoneme',
    'SECFIgnoreKanaType', 'Speech_StreamPos_RealTime',
    'DISPID_SDKDeleteKey', 'SVP_1', 'DISPID_SOTDisplayUI', 'SINoise',
    'DISPID_SASCurrentSeekPosition', 'ISpStreamFormatConverter',
    'SpeechVoiceSkipTypeSentence', 'SVEVoiceChange',
    'DISPID_SRCBookmark', 'DISPID_SVAudioOutput',
    'DISPID_SpeechGrammarRuleStateTransition', 'SRARoot',
    'DISPID_SPRs_NewEnum', 'SpFileStream', 'SPPHRASERULE',
    'DISPID_SABIEventBias', 'IInternetSecurityManager',
    'SPINTERFERENCE_LATENCY_WARNING', 'STCRemoteServer',
    'DISPID_SLRemovePronunciation', 'SP_VISEME_19',
    'DISPID_SVSLastBookmarkId', 'SpeechDictationTopicSpelling',
    'ISpeechPhraseAlternates', 'DISPID_SpeechAudioFormat',
    'SpeechRecognizerState', 'SPPS_Verb', 'eLEXTYPE_RESERVED9',
    'DISPID_SLPType', 'SpeechRuleAttributes',
    'DISPID_SPAStartElementInResult', 'SGSEnabled',
    'SpeechDataKeyLocation', '__MIDL_IWinTypes_0009',
    'DISPID_SABufferNotifySize', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SOTCSetId', 'SpeechTokenKeyUI', 'DISPID_SVSLastResult',
    'eLEXTYPE_USER', 'DISPID_SpeechFileStream', 'SPSHT_NotOverriden',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SpeechAudioStatus',
    'DISPID_SWFEAvgBytesPerSec', 'SBOPause', 'SITooLoud',
    'ISpNotifyTranslator', 'Speech_Max_Word_Length',
    'DISPID_SPAsCount', 'SPTEXTSELECTIONINFO',
    'DISPID_SRGIsPronounceable', 'DISPID_SRCEPropertyNumberChange',
    'SVSFNLPSpeakPunc', 'DISPID_SPAs_NewEnum',
    'DISPID_SRCEEnginePrivate', 'DISPID_SFSClose', 'DISPID_SGRSTType',
    'DISPID_SLWsCount', 'eLEXTYPE_PRIVATE16', 'SpNullPhoneConverter',
    'DISPID_SDKOpenKey', 'SpeechStreamFileMode', 'DISPID_SPRulesItem',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SOTsCount', 'SPPS_RESERVED3', 'SPPS_RESERVED1',
    'DISPID_SRRecognizer', 'DISPID_SWFEChannels', 'SRERequestUI',
    'SpeechRunState', 'DISPID_SPRuleParent', 'SPSNotOverriden',
    'DISPID_SRProfile', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SpeechAudio', 'DISPID_SpeechGrammarRules', 'SPRULESTATE',
    'IInternetSecurityMgrSite', 'ISpeechTextSelectionInformation',
    'SpNotifyTranslator', 'DISPID_SPIGrammarId',
    'SpeechRegistryUserRoot', 'DISPID_SPRules_NewEnum',
    'SRCS_Disabled', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SpeechObjectToken', 'SPAR_High', 'SSFMCreateForWrite',
    'SPEI_SR_RETAINEDAUDIO', 'SPRECOCONTEXTSTATUS', 'ISpAudio',
    'SRSActive', 'SPSInterjection', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SWFEFormatTag',
    'SVSFParseSapi', 'SPBO_PAUSE', 'SAFT24kHz16BitMono',
    'SAFT48kHz16BitStereo', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPIGetDisplayAttributes', 'SAFT11kHz8BitMono',
    'SAFT22kHz8BitStereo', 'ISpeechRecognizer', 'ISpRecognizer2',
    'SPCT_SUB_DICTATION', 'DISPID_SPRsItem',
    'DISPID_SPRDisplayAttributes', 'DISPID_SpeechRecoResultTimes',
    'SPAO_NONE', 'SPAUDIOSTATUS', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SRGSetTextSelection', 'SPGS_ENABLED', 'SAFT32kHz8BitMono',
    'DISPID_SpeechBaseStream', 'SAFT12kHz16BitStereo',
    'Speech_StreamPos_Asap', 'DISPID_SPEs_NewEnum', 'SP_VISEME_1',
    'SVP_12', 'DISPID_SDKGetBinaryValue', 'DISPID_SGRSTPropertyId',
    'SPVPRI_NORMAL', 'SDTAudio', 'SpPhraseInfoBuilder',
    'SPCT_DICTATION', 'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRRTLength',
    'ISpeechObjectTokens', 'DISPID_SVSInputWordLength',
    'SPEI_RESERVED1', 'eLEXTYPE_PRIVATE11',
    'SAFTCCITT_uLaw_44kHzStereo', 'eLEXTYPE_PRIVATE2',
    'DISPID_SRRGetXMLResult', 'SVF_Emphasis', 'SPEI_SR_PRIVATE',
    'DISPID_SAFGuid', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SLGenerationId', 'ISpEventSink', 'SVP_3',
    'DISPID_SGRsItem', 'ISpeechLexiconPronunciations',
    'SPRECOGNIZERSTATUS', 'DISPID_SPIStartTime', 'SPCT_SLEEP',
    'DISPID_SRCCmdMaxAlternates', 'SPPS_Noncontent',
    'SPWT_PRONUNCIATION', 'DISPID_SVResume', 'SVP_20',
    'DISPID_SPCIdToPhone', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SPELexicalForm', 'DISPID_SPEAudioTimeOffset',
    'SPAUDIOSTATE', 'SAFT24kHz8BitMono', 'DISPID_SRSAudioStatus',
    'SAFT11kHz16BitStereo', 'SSSPTRelativeToEnd', 'SPINTERFERENCE',
    'DISPID_SVIsUISupported', 'SAFT22kHz16BitMono', 'SPRST_ACTIVE',
    'SVP_7', 'DISPID_SDKSetStringValue', 'SPPS_Function',
    'eLEXTYPE_PRIVATE7', 'SPXRO_SML', 'DISPID_SAEventHandle',
    'DISPID_SRCEPhraseStart', 'DISPID_SRGDictationUnload',
    'ISpeechLexiconPronunciation', 'ISpeechXMLRecoResult',
    'ISpeechPhraseElement', 'eLEXTYPE_RESERVED7',
    'DISPID_SPAPhraseInfo', 'SPEI_HYPOTHESIS',
    'SPEI_RECO_OTHER_CONTEXT', 'SpCustomStream', 'SWTAdded',
    'SVSFIsXML', 'DISPID_SRIsShared', 'SPSEMANTICFORMAT',
    'SpResourceManager', 'DISPID_SLAddPronunciationByPhoneIds',
    'SVP_9', 'DISPID_SpeechVoice', 'SPWT_DISPLAY',
    'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechPhraseProperties', 'SVEBookmark', 'SVEPrivate',
    'SVP_16', 'SWPKnownWordPronounceable', 'DISPID_SLPsItem',
    'DISPID_SRCEFalseRecognition', 'DISPID_SVGetVoices',
    'ISpeechPhraseElements', 'DISPID_SVSInputWordPosition',
    'SP_VISEME_14', 'ISpeechLexiconWord', 'SP_VISEME_4',
    'SpeechRecoProfileProperties', 'ISpRecoResult',
    'SAFT8kHz8BitStereo', 'SRTExtendableParse', 'DISPID_SOTsItem',
    'ISpeechPhraseReplacements', 'DISPID_SLPsCount', 'ISpPhrase',
    'SRTAutopause', 'SVEEndInputStream', 'SAFTADPCM_22kHzStereo',
    'DISPID_SOTCDefault', 'SVESentenceBoundary', 'SAFT48kHz16BitMono',
    'SPWORD', 'DISPID_SPPParent', 'SAFTCCITT_ALaw_22kHzMono',
    'SPPS_RESERVED2', 'ISpSerializeState', 'DISPID_SPARecoResult',
    'DISPID_SWFEBlockAlign', 'SRESoundEnd', 'SAFTADPCM_44kHzStereo',
    'SDTAlternates', 'DISPIDSPTSI_SelectionOffset',
    'SpeechRecognitionType', 'SREPropertyNumChange', 'SVP_17',
    'DISPID_SFSOpen', 'SPEI_MAX_TTS', 'SpAudioFormat',
    'DISPID_SMSSetData', 'DISPID_SLWWord', 'DISPID_SBSFormat',
    'eLEXTYPE_PRIVATE12', 'SVPNormal', 'DISPID_SABIBufferSize',
    ...
    'DISPID_SpeechVoiceEvent', 'SpeechGrammarState',
    'SPXRO_Alternates_SML', 'SPSModifier', 'SpeechCategoryAudioIn',
    'SPPHRASEREPLACEMENT', 'SVSFIsNotXML', 'SPWF_INPUT',
    'DISPID_SGRsDynamic', 'DISPID_SOTRemove', 'SPEI_REQUEST_UI',
    'SECFIgnoreCase', 'DISPID_SVAudioOutputStream',
    'DISPID_SPPChildren', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SAFT48kHz8BitStereo', 'ISpObjectToken', 'SAFT44kHz16BitStereo',
    'SVP_18', 'DISPID_SRAudioInput', 'DISPID_SCSBaseStream',
    'DISPID_SLWPronunciations', 'DISPIDSPRG', 'SPSLMA',
    'SGPronounciation', 'DISPID_SGRsCommitAndSave', 'SPSHORTCUTTYPE',
    'SPFM_CREATE_ALWAYS', 'SpeechStreamSeekPositionType',
    'ISpeechPhraseReplacement', 'SPAO_RETAIN_AUDIO',
    'SVSFParseAutodetect', 'DISPID_SPEAudioStreamOffset',
    'SAFT12kHz8BitStereo', 'DISPID_SASFreeBufferSpace',
    'STCInprocHandler', 'SPFM_OPEN_READWRITE', 'SAFT22kHz8BitMono',
    'SREFalseRecognition', 'SSTTDictation',
    'DISPID_SRGSetWordSequenceData', 'SAFT44kHz8BitStereo',
    'DISPID_SOTMatchesAttributes', 'SRAORetainAudio',
    'DISPID_SVSVisemeId', 'SPPS_SuppressWord', 'SpeechInterference',
    'DISPID_SRGRules', 'DISPID_SMSAMMHandle', 'SAFT48kHz8BitMono',
    'SPCT_SUB_COMMAND', 'SGDSActive', 'DISPID_SRRSetTextFeedback',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SPANumberOfElementsInResult', 'ISpPhraseAlt',
    'DISPID_SpeechPhoneConverter', 'SPDATAKEYLOCATION',
    'DISPID_SVSkip', 'SpMMAudioOut', 'tagSTATSTG', 'STSF_AppData',
    'ISpPhoneticAlphabetSelection', 'DISPID_SPPNumberOfElements',
    'DISPID_SpeechPhraseRules', 'SDTAll', 'SPAS_CLOSED',
    'SPLOADOPTIONS', 'DISPID_SVPriority', 'SVSFDefault',
    'ISpeechRecoContext', 'DISPID_SGRsAdd', 'SECNormalConfidence',
    'DISPID_SOTs_NewEnum', 'SAFT16kHz8BitMono',
    'SAFT16kHz16BitStereo', 'SVSFUnusedFlags', 'SP_VISEME_18',
    'SPLO_STATIC', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SLWs_NewEnum', 'ISpRecoCategory',
    'DISPID_SpeechMMSysAudio', 'SPAR_Low', 'SpeechTokenKeyAttributes',
    'SpeechWordPronounceable', 'SGDisplay', 'SPWORDTYPE',
    'DISPID_SRRDiscardResultInfo', 'SRSEDone', 'DISPID_SRRSpeakAudio',
    'SVP_15', 'SREPrivate', 'DISPID_SpeechVoiceStatus',
    'DISPID_SVGetAudioInputs', 'DISPID_SPPEngineConfidence',
    'DISPID_SPRuleConfidence', 'SPEI_SENTENCE_BOUNDARY',
    'SGDSActiveWithAutoPause', 'ISpNotifySource', 'SVSFIsFilename',
    'DISPID_SVVoice', 'DISPID_SRGCommit',
    'DISPID_SPIRetainedSizeBytes', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRGRecoContext', 'SVP_13', 'SVP_19', 'SPRULE',
    'SINoSignal', 'SPINTERFERENCE_NONE', 'SPBO_NONE',
    'DISPID_SREmulateRecognition', 'SP_VISEME_8',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPSSuppressWord',
    'SPDKL_DefaultLocation', 'SpLexicon', 'eWORDTYPE_DELETED',
    'ISpRecoContext', 'SGSExclusive', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPPName', 'DISPID_SABufferInfo', 'ISpeechRecoResult',
    'SP_VISEME_17', 'DISPID_SLPPhoneIds', 'SPBINARYGRAMMAR',
    'SRTSMLTimeout', 'SVP_6', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpProperties', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SpeechWaveFormatEx', 'SVSFParseMask',
    'eLEXTYPE_RESERVED10', 'SPPARTOFSPEECH', 'ISpRecognizer3',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SpeechRecoResult',
    'DISPID_SBSSeek', 'SAFTGSM610_11kHzMono', 'DISPID_SRCEHypothesis',
    'SPVOICESTATUS', 'DISPID_SPILanguageId', 'SAFTNoAssignedFormat',
    'SPWT_LEXICAL', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRRRecoContext', 'SVP_11', 'SPEI_MIN_TTS', 'SPAS_PAUSE',
    'SpeechGrammarTagUnlimitedDictation', 'SPINTERFERENCE_TOOSLOW',
    'SVP_0', 'DISPID_SVVolume', 'ISpeechAudioFormat',
    'SAFTExtendedAudioFormat', 'DISPID_SpeechPhraseInfo',
    'DISPID_SWFEBitsPerSample', 'SPSTREAMFORMATTYPE',
    'SpCompressedLexicon', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPEAudioSizeTime', 'SPDKL_CurrentUser', 'SPEI_PHONEME',
    'SVEStartInputStream', 'SREPropertyStringChange',
    'SPDKL_CurrentConfig', 'DISPID_SGRSTsItem', 'SPEI_MIN_SR',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SVSpeak',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPSMF_SAPI_PROPERTIES',
    'SPSHORTCUTPAIR', 'eLEXTYPE_RESERVED4', 'DISPID_SMSALineId',
    'DISPID_SRRPhraseInfo', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPRsCount', 'ISpeechAudioBufferInfo',
    'STSF_CommonAppData', 'SP_VISEME_5', 'ISpGrammarBuilder',
    'DISPID_SpeechPhraseBuilder', 'SAFT44kHz8BitMono',
    'SpeechCategoryPhoneConverters', 'SpeechAudioVolume',
    'DISPID_SOTId', 'DISPID_SGRId', 'DISPID_SGRSTNextState',
    'SpObjectToken', '_ISpeechRecoContextEvents', 'DISPID_SPPsItem',
    'SpShortcut', 'DISPID_SVSInputSentencePosition', 'SPEI_UNDEFINED',
    'SAFTDefault', 'SREAdaptation', 'DISPID_SPRulesCount',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRCEStartStream',
    'DISPID_SGRsFindRule', 'SpVoice', 'DISPID_SAStatus',
    'SVSFPersistXML', 'LONG_PTR', 'SPXMLRESULTOPTIONS',
    'DISPID_SpeechPhraseRule', 'SPRST_INACTIVE', 'DISPID_SPIEngineId',
    'DISPID_SGRSTPropertyName', 'SGRSTTTextBuffer', 'IStream',
    'SpeechVoiceSpeakFlags', 'SPRST_INACTIVE_WITH_PURGE', 'SBONone',
    'DISPID_SGRAddState', 'DISPID_SPRuleChildren',
    'DISPID_SOTGetDescription', 'SRSEIsSpeaking', 'SAFT12kHz8BitMono',
    'DISPID_SLGetWords', 'DISPID_SVEVoiceChange',
    'DISPID_SPRFirstElement', 'SpeechVisemeType', 'SPSVerb', 'SVP_8',
    'DISPID_SRCCreateGrammar', 'DISPID_SLGetGenerationChange',
    'SPFM_OPEN_READONLY', 'SVPOver', 'ISpRecoGrammar2',
    'DISPID_SPEDisplayText', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRGCmdLoadFromResource', 'SRTEmulated', 'STSF_FlagCreate',
    'SGRSTTEpsilon', 'ISpeechLexiconWords',
    'DISPID_SPPBRestorePhraseFromMemory', 'SDA_One_Trailing_Space',
    'SRERecoOtherContext', 'SPEI_VOICE_CHANGE', 'DISPID_SVEWord',
    'SECLowConfidence', 'SpeechFormatType', 'ISpNotifySink',
    ...
    'DISPID_SpeechXMLRecoResult', 'ISpeechRecoGrammar',
    'DISPID_SDKCreateKey', 'SpeechGrammarWordType',
    'DISPID_SWFEExtraData', 'SpeechEngineConfidence',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPRECOSTATE',
    'SpeechPropertyComplexResponseSpeed', 'SPSMF_UPS',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SVEEnginePrivate', 'SDTPronunciation',
    'DISPID_SRCEBookmark', 'SpeechPropertyHighConfidenceThreshold',
    'SSSPTRelativeToStart', 'DISPID_SRRTimes',
    'DISPID_SRSSupportedLanguages', 'eLEXTYPE_PRIVATE19',
    'SVEWordBoundary', 'SPSHT_OTHER', 'DISPID_SPEActualConfidence',
    'SPEI_RESERVED2', 'SPCONTEXTSTATE', 'DISPID_SVAlertBoundary',
    'SSFMCreate', 'SpeechPartOfSpeech', 'SPGRAMMARSTATE',
    'DISPID_SpeechLexiconProns',
    'DISPID_SRCAudioInInterferenceStatus', 'SpInProcRecoContext',
    'SWPUnknownWordPronounceable', 'SPSEMANTICERRORINFO',
    'DISPID_SOTGetAttribute', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPAR_Unknown', 'DISPID_SPRuleFirstElement',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPRText',
    'DISPID_SPEEngineConfidence', 'DISPID_SVEViseme',
    'DISPID_SVDisplayUI', 'DISPID_SRRTTickCount',
    'SpeechVoiceCategoryTTSRate', 'SASPause', 'SPPS_LMA',
    'SAFT11kHz8BitStereo', 'SGRSTTRule', 'DISPID_SOTSetId',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpeechPhraseInfo',
    'DISPID_SAFType', 'ISpeechRecoResult2', 'SRESoundStart',
    'eLEXTYPE_PRIVATE4', 'DISPID_SpeechLexiconWords',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechMemoryStream', 'SPPS_Unknown',
    'SPWF_SRENGINE', 'SAFT8kHz16BitStereo', 'SPEI_RESERVED3',
    'DISPID_SASNonBlockingIO', 'SRTStandard', 'SPSHT_EMAIL',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRRAudio',
    '_ISpeechVoiceEvents', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SPPs_NewEnum', 'SPGS_DISABLED',
    'DISPID_SOTCEnumerateTokens', 'SLOStatic', 'SRAExport',
    'SRAInterpreter', 'DISPID_SRCEInterference', 'ISpeechPhraseRules',
    'ISpRecognizer', 'SPAR_Medium', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRGState', 'SpeechTokenShellFolder',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SRSClsidEngine', 'SPAS_STOP', 'SpeechCategoryAppLexicons',
    'DISPID_SRGCmdLoadFromMemory', 'eLEXTYPE_PRIVATE13',
    'DISPID_SVSRunningState', 'SpeechTokenValueCLSID',
    'DISPID_SOTCategory', 'SVSFVoiceMask', 'SAFTCCITT_ALaw_8kHzMono',
    'SREAllEvents', 'DISPID_SMSGetData', 'SPEI_MAX_SR',
    'SVSFParseSsml', 'DISPID_SLPSymbolic', 'SGLexicalNoSpecialChars',
    'SGRSTTWord', 'DISPID_SVEBookmark', 'DISPID_SGRSTRule',
    'ISpeechPhraseProperties', 'SpeechRecoContextState',
    'DISPID_SRCEAdaptation', 'eLEXTYPE_VENDORLEXICON',
    'SECFNoSpecialChars', 'SGSDisabled', 'DISPID_SVEAudioLevel',
    'UINT_PTR', 'SRSInactive', 'ISpeechVoiceStatus',
    'SPEI_END_SR_STREAM', 'DISPID_SVSLastBookmark', 'DISPID_SAVolume',
    'IEnumSpObjectTokens', 'SpSharedRecognizer',
    'DISPID_SPERequiredConfidence', 'SAFT8kHz8BitMono',
    'SpeechTokenKeyFiles', 'SDKLDefaultLocation',
    'tagSPTEXTSELECTIONINFO', 'SPEI_RECOGNITION', 'ISpXMLRecoResult',
    'SRADefaultToActive', 'DISPID_SRGDictationSetState',
    'DISPID_SGRInitialState', 'SpMemoryStream', 'SPWORDPRONUNCIATION',
    'DISPID_SMSADeviceId', 'SVEAudioLevel', 'DISPID_SPCLangId',
    'DISPID_SPCPhoneToId', 'DISPID_SpeechPhraseElement',
    'DISPID_SRCVoice', 'SpeechVoicePriority',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpeechAudioProperties',
    'SPGS_EXCLUSIVE', 'SRAONone', 'DISPID_SpeechRecognizer',
    'SPVPRI_OVER', 'SPINTERFERENCE_TOOLOUD', 'SPRST_NUM_STATES',
    'SLTApp', 'SASRun', 'SPBO_AHEAD', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRIsUISupported', 'SPAUDIOOPTIONS', 'SPLO_DYNAMIC',
    'SPCATEGORYTYPE', 'SpeechAddRemoveWord', 'SRSActiveAlways',
    'SVP_5', 'DISPID_SOTDataKey', 'DISPID_SOTRemoveStorageFileName',
    'SPWAVEFORMATTYPE', 'SDKLCurrentUser',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpStream',
    'SPPROPERTYINFO', 'SITooSlow',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCESoundStart', 'DISPID_SGRSTText',
    'DISPID_SPPConfidence', 'SLODynamic', 'DISPID_SVGetProfiles',
    'DISPID_SDKGetlongValue', 'SPBOOKMARKOPTIONS',
    'DISPID_SRRGetXMLErrorInfo', 'SPEVENT', 'SPPHRASE',
    'DISPID_SPACommit', 'SpeechAudioState', 'DISPID_SLWType',
    'SP_VISEME_6', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SASState', 'SP_VISEME_9', 'SPEVENTENUM',
    'DISPID_SPEDisplayAttributes', 'SPPS_NotOverriden',
    'DISPID_SGRSTsCount', 'ISpeechVoice', 'SVEPhoneme',
    'SAFTGSM610_22kHzMono', 'SVPAlert', 'DISPID_SBSWrite',
    'DISPID_SGRClear', 'DISPID_SBSRead', 'SP_VISEME_16',
    'DISPID_SpeechRecoContext', 'DISPID_SGRSAddRuleTransition',
    'SpeechCategoryRecognizers', 'SAFTText',
    'DISPID_SOTIsUISupported', 'SPWORDLIST',
    'SpeechSpecialTransitionType', 'DISPID_SDKGetStringValue',
    'DISPID_SRStatus', 'SpTextSelectionInformation',
    'ISpRecoContext2', 'DISPID_SpeechPhraseElements', 'SPVPRIORITY',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechObjectTokens',
    'SAFTADPCM_22kHzMono', 'DISPID_SPPId', 'DISPID_SRCESoundEnd',
    'SECFDefault', 'DISPIDSPTSI_ActiveOffset', 'SP_VISEME_7',
    'DISPID_SRGetFormat', 'DISPID_SpeechPhraseReplacements',
    'ISpObjectTokenCategory', 'SPINTERFERENCE_NOSIGNAL',
    'SPEI_START_INPUT_STREAM', 'SECFIgnoreWidth',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRGetPropertyNumber',
    'ISpeechAudio', 'SAFT16kHz16BitMono', 'ISpLexicon',
    'DISPID_SRCEAudioLevel', 'SPEI_ADAPTATION',
    'SpeechEmulationCompareFlags', 'eLEXTYPE_PRIVATE18',
    'DISPID_SRAudioInputStream', 'SSTTTextBuffer', 'eLEXTYPE_APP',
    'SPPS_RESERVED4', 'SGLexical', 'DISPID_SPIProperties',
    'ISpStreamFormat', 'ISpeechPhraseProperty',
    'SpeechEngineProperties', 'SpeechCategoryAudioOut',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SP_VISEME_3',
    'SAFTTrueSpeech_8kHz1BitMono', 'SAFTCCITT_uLaw_22kHzMono',
    'eLEXTYPE_PRIVATE17', 'ISpeechPhraseRule', 'SAFT44kHz16BitMono',
    'DISPID_SRGReset', 'DISPID_SpeechLexicon', 'SVP_2',
    'Speech_Default_Weight', 'SWTDeleted', 'SpInprocRecognizer',
    'SpStream', 'SAFTADPCM_8kHzStereo', 'SREPhraseStart',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SRTReSent',
    'DISPID_SVWaitUntilDone', 'SPEI_END_INPUT_STREAM',
    'ISpeechObjectTokenCategory', 'SDKLCurrentConfig',
    'SAFT22kHz16BitStereo', 'DISPID_SPRuleId',
    'DISPID_SVESentenceBoundary', 'SpeechGrammarTagDictation',
    'DISPID_SpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE6',
    'SGDSInactive', 'ISpeechGrammarRuleStateTransitions',
    '_SPAUDIOSTATE', 'SpeechCategoryVoices', 'eLEXTYPE_PRIVATE20',
    'SRATopLevel', 'DISPID_SRGetRecognizers',
    'DISPID_SVSLastStreamNumberQueued', 'SPVISEMES',
    ...
    'DISPID_SRRAlternates', 'SVSFlagsAsync', 'SPBO_TIME_UNITS',
    'SREBookmark', 'SITooFast', 'DISPID_SLPLangId',
    'DISPID_SLPs_NewEnum', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRCreateRecoContext', 'ISpeechResourceLoader',
    'DISPID_SPISaveToMemory', 'SPEI_RECO_STATE_CHANGE',
    'SpeechPropertyResponseSpeed', 'SAFT32kHz16BitStereo',
    'SpeechTokenIdUserLexicon', 'ISpRecoGrammar', '_RemotableHandle',
    'DISPID_SABIMinNotification', 'SPEI_INTERFERENCE',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPLEXICONTYPE',
    'DISPID_SPRNumberOfElements', 'SPSERIALIZEDPHRASE',
    'DISPID_SRRAudioFormat', 'SAFT32kHz8BitStereo'
=======
# code template for ISpeechRecognizerStatus implementation
# class ISpeechRecognizerStatus_Impl(object):
#     @property
...
__all__ = [
    'DISPID_SAStatus', 'SPCS_DISABLED', 'ISpeechVoiceStatus',
    'SPFILEMODE', 'DISPID_SRGSetTextSelection', 'SGDSActive',
    'SREAllEvents', 'DISPID_SAFType', 'ISpStream',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechPhraseAlternates',
    'DISPID_SVPriority', 'SPSHT_OTHER', 'SpNotifyTranslator',
    'DISPID_SPIRule', 'DISPID_SVEventInterests',
    'DISPID_SPEAudioSizeTime',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPRECOGNIZERSTATUS', 'DISPID_SRCEFalseRecognition',
    'DISPID_SVSkip', 'eLEXTYPE_PRIVATE15', 'DISPID_SMSGetData',
    'DISPID_SVEViseme', 'DISPID_SVGetAudioInputs', 'SREStreamStart',
    'SP_VISEME_5', 'eLEXTYPE_LETTERTOSOUND', 'DISPID_SGRSTWeight',
    'SVPNormal', 'SPWORDLIST', 'DISPID_SWFEAvgBytesPerSec',
    'SpeechCategoryRecoProfiles', 'SPINTERFERENCE_LATENCY_WARNING',
    'SP_VISEME_18', 'DISPID_SVEStreamStart', 'DISPID_SPAsItem',
    'ISpeechGrammarRules', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechPhraseAlternate', 'DISPID_SVVoice',
    'SPAO_RETAIN_AUDIO', 'SSFMOpenReadWrite', 'SPWORDTYPE',
    'DISPID_SPIAudioSizeBytes', 'SAFT32kHz16BitMono', 'SITooFast',
    'SPPS_RESERVED3', 'DISPID_SRCVoicePurgeEvent', 'DISPID_SGRClear',
    'SPAR_Unknown', 'SRCS_Enabled', 'SDTAll', 'DISPID_SRCResume',
    'SVF_Stressed', 'DISPID_SPRNumberOfElements', 'SASRun',
    'ISpeechPhraseReplacement', 'ISpProperties', 'eLEXTYPE_RESERVED7',
    'SAFT12kHz8BitMono', 'DISPID_SpeechFileStream',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPAR_Low', 'SPAUDIOSTATE',
    'DISPIDSPRG', 'SPRECOCONTEXTSTATUS', 'SpeechAudioFormatGUIDWave',
    'DISPID_SRCEBookmark', 'STCInprocHandler', 'SPSEMANTICERRORINFO',
    'SSTTWildcard', 'eLEXTYPE_PRIVATE18', 'SDKLCurrentConfig',
    'SPEI_WORD_BOUNDARY', 'DISPID_SGRAttributes',
    'SAFTADPCM_44kHzStereo', 'SPPS_Verb',
    'DISPID_SVAudioOutputStream', 'DISPID_SRGCmdLoadFromFile',
    'Speech_Max_Pron_Length', 'DISPID_SpeechAudioStatus',
    'SECFIgnoreKanaType', 'SpeechRuleState', 'SPPS_RESERVED4',
    'SpeechTokenValueCLSID', 'DISPID_SVSInputSentenceLength',
    'ISpeechPhraseRule', 'SAFT8kHz8BitMono', 'SINone',
    'SPEI_SOUND_END', 'DISPID_SOTCGetDataKey', 'SPEI_RESERVED5',
    'SPEI_END_INPUT_STREAM', 'SpInProcRecoContext', 'SPWT_LEXICAL',
    'SPSMF_UPS', 'SDA_One_Trailing_Space', 'SLODynamic', 'SVP_8',
    'DISPID_SOTs_NewEnum', 'SPEI_ADAPTATION',
    'DISPID_SVIsUISupported', 'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRSetPropertyString', 'SAFTADPCM_8kHzStereo',
    'SPEI_SOUND_START', 'ISpeechRecoResultDispatch',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SRCRetainedAudio', 'SPXRO_Alternates_SML',
    'DISPID_SpeechGrammarRule', 'DISPID_SVSVisemeId',
    'SAFT16kHz8BitStereo', 'eLEXTYPE_PRIVATE2', 'SVSFUnusedFlags',
    'SPAS_STOP', 'DISPID_SRRTTickCount', 'SPSUnknown',
    'SpObjectToken', 'SPWORDPRONOUNCEABLE', 'ISpeechRecognizerStatus',
    'eLEXTYPE_APP', 'SPPHRASE', 'SAFTCCITT_ALaw_11kHzMono',
    'SpeechPropertyResourceUsage', 'SDTDisplayText', 'SRAONone',
    'DISPID_SRCVoice', 'SP_VISEME_2', 'SPBO_NONE', 'SPBO_PAUSE',
    'SpMMAudioOut', 'SPDKL_CurrentUser', 'SVP_6', 'SpeechVisemeType',
    'SAFTGSM610_22kHzMono', 'ISpPhoneticAlphabetSelection',
    'eLEXTYPE_PRIVATE4', 'ISpPhoneConverter', 'SpeechStreamFileMode',
    'DISPID_SRGId', 'DISPID_SGRSRule', 'SPBO_AHEAD', 'SVSFIsXML',
    'SpeechDictationTopicSpelling', 'SPEI_REQUEST_UI',
    'STSF_FlagCreate', 'DISPID_SRCRequestedUIType',
    'DISPID_SRCEAudioLevel', 'DISPID_SPEDisplayAttributes',
    'SpeechTokenKeyFiles', 'DISPID_SRCEPhraseStart', 'SDTAudio',
    'SPSHT_NotOverriden', 'DISPID_SpeechObjectToken', 'SRTStandard',
    'SAFTCCITT_ALaw_44kHzMono', 'SPRECOSTATE', 'eLEXTYPE_PRIVATE13',
    'SpeechGrammarRuleStateTransitionType', 'SAFTNonStandardFormat',
    'DISPID_SPRuleId', 'SPSEMANTICFORMAT', 'SPSSuppressWord',
    'DISPID_SDKGetBinaryValue', 'SPINTERFERENCE_NOISE',
    'DISPID_SLGetGenerationChange', 'SAFT48kHz8BitMono',
    'SVSFPersistXML', 'ISpeechObjectTokenCategory',
    'DISPID_SRCEventInterests', 'SPPS_Noncontent',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SpeechRecoResult',
    'DISPID_SAFGuid', 'SVSFVoiceMask', 'STSF_CommonAppData',
    'DISPID_SWFEChannels', 'ISpEventSink', 'DISPID_SRRAudio',
    'DISPID_SPEAudioStreamOffset', 'SVPOver',
    'ISpeechGrammarRuleState', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechAudioFormatGUIDText', 'DISPID_SLPsItem',
    'DISPID_SRRAlternates', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SpeechVoiceStatus', 'eLEXTYPE_PRIVATE1',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SPIGetText',
    'SP_VISEME_12', 'DISPID_SPEAudioTimeOffset',
    'DISPID_SVGetProfiles', 'ISpNotifySink',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPEsItem',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SRGSetWordSequenceData',
    'eLEXTYPE_RESERVED9', 'SRSActiveAlways', 'ISpMMSysAudio',
    'SAFT44kHz16BitMono', 'SRADynamic', 'SVP_10', 'SPEI_RESERVED6',
    ...
    'SPPHRASEPROPERTY', 'eLEXTYPE_PRIVATE16',
    'DISPID_SOTGetStorageFileName', 'DISPID_SPRulesItem',
    'DISPID_SpeechPhraseProperty', 'SAFT48kHz16BitStereo',
    'SPINTERFERENCE', 'SREStateChange',
    'DISPID_SRCEPropertyNumberChange', 'SAFT32kHz16BitStereo',
    'eLEXTYPE_RESERVED6', 'Speech_StreamPos_RealTime',
    'ISpeechLexiconWords', 'DISPID_SVVolume', 'SPSHORTCUTTYPE',
    'SDKLDefaultLocation', 'SPEI_PHONEME',
    'ISpeechPhraseReplacements', 'SSFMCreate', 'DISPID_SPPsCount',
    'eLEXTYPE_PRIVATE7', 'DISPID_SFSOpen', 'SPPS_LMA',
    'DISPID_SGRSTs_NewEnum', 'SRERecoOtherContext',
    'SPWORDPRONUNCIATIONLIST', 'SPGS_ENABLED', 'ISpResourceManager',
    'SREHypothesis', 'SpeechWordType', 'DISPID_SVGetAudioOutputs',
    'SpeechGrammarState', 'DISPID_SDKGetStringValue',
    'SGRSTTDictation', 'DISPID_SGRAddState', 'SRSEIsSpeaking',
    'DISPID_SPPEngineConfidence',
    'SpeechPropertyComplexResponseSpeed', 'SPBINARYGRAMMAR',
    'DISPIDSPTSI', 'DISPID_SVSInputSentencePosition',
    'ISpeechPhraseInfo', 'DISPID_SPEAudioSizeBytes', 'WAVEFORMATEX',
    'ISpSerializeState', 'SGDisplay', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SVSRunningState', 'SpeechFormatType', 'DISPID_SPACommit',
    'SVP_11', 'DISPID_SPAPhraseInfo', 'DISPID_SRIsUISupported',
    'ISpeechCustomStream', 'SGLexicalNoSpecialChars', 'SPPS_Unknown',
    'SDA_No_Trailing_Space', 'SpeechTokenContext', 'SPVPRI_OVER',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPGS_EXCLUSIVE', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SPPValue', 'SpeechSpecialTransitionType',
    'DISPID_SLWs_NewEnum', 'DISPID_SPEEngineConfidence', 'SASStop',
    'SAFT44kHz8BitStereo', 'DISPID_SLGenerationId', 'SRERecognition',
    'DISPID_SRCEAdaptation', 'DISPID_SGRSAddWordTransition',
    'ISpStreamFormat', 'DISPID_SGRInitialState', 'SFTSREngine',
    'DISPID_SRCESoundStart', 'SRCS_Disabled', 'SpeechRunState',
    'DISPID_SGRSTText', 'DISPID_SLAddPronunciation',
    'DISPID_SVSLastResult', 'eWORDTYPE_DELETED',
    'SREFalseRecognition', 'SGSExclusive', 'SPCT_SUB_DICTATION',
    'DISPID_SGRs_NewEnum', 'SPWT_DISPLAY', 'DISPID_SLWPronunciations',
    'SPFM_NUM_MODES', 'DISPID_SVPause', 'DISPID_SVSpeakCompleteEvent',
    'SRESoundStart', 'DISPID_SAEventHandle',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SDKCreateKey',
    'DISPID_SRRTimes', 'SP_VISEME_15', 'DISPID_SLGetPronunciations',
    'SVP_18', 'SpPhoneConverter', 'SPAS_RUN', 'SGLexical',
    'SP_VISEME_11', 'eWORDTYPE_ADDED', 'SPPS_Function',
    'SpeechMicTraining', 'SpeechRecognitionType',
    'SpPhraseInfoBuilder', 'SAFT22kHz16BitStereo',
    '_ISpeechVoiceEvents', 'DISPID_SPILanguageId',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SOTCId',
    'SGSEnabled', 'SpeechGrammarWordType',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SpeechLexicon',
    'SPEI_END_SR_STREAM', 'SVP_15', 'SVEEndInputStream',
    'DISPID_SpeechAudio', 'DISPID_SMSALineId',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPRuleEngineConfidence', 'eLEXTYPE_PRIVATE17',
    '_ISpeechRecoContextEvents', 'ISpAudio', 'DISPID_SRRGetXMLResult',
    'SP_VISEME_10', 'SpTextSelectionInformation',
    'SAFT44kHz16BitStereo', 'SpMMAudioEnum',
    'DISPID_SpeechPhraseElements', 'SAFT44kHz8BitMono',
    'SAFT24kHz8BitMono', 'SPGS_DISABLED', 'DISPID_SRDisplayUI',
    'DISPID_SGRsCount', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechLexiconWord', 'DISPID_SpeechPhraseElement',
    'DISPID_SVSpeak', 'STCInprocServer', 'DISPID_SPCPhoneToId',
    'SPLO_DYNAMIC', 'DISPID_SBSFormat', 'SAFT24kHz16BitMono',
    'SPAS_CLOSED', 'DISPID_SPELexicalForm', 'ISpXMLRecoResult',
    'SpeechVoiceSkipTypeSentence', 'ISpeechPhraseProperty',
    'DISPID_SRGCmdLoadFromMemory', 'SP_VISEME_8',
    'DISPID_SPPFirstElement', 'DISPID_SLPs_NewEnum',
    'DISPID_SPIReplacements', 'SGRSTTRule', 'SVP_5',
    'SpeechRecoProfileProperties', 'DISPID_SLWsCount',
    'ISequentialStream', 'SpeechDataKeyLocation',
    'DISPID_SRCERecognitionForOtherContext', 'SVP_20',
    'DISPID_SPIRetainedSizeBytes', 'SPAR_Medium', 'SP_VISEME_14',
    'SAFTADPCM_22kHzMono', 'SPPS_RESERVED1', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SASNonBlockingIO', 'SRAORetainAudio', 'ISpeechFileStream',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SPPParent', 'SRAExport', 'ISpeechGrammarRule',
    'DISPID_SPRuleParent', 'SP_VISEME_9', 'DISPID_SLWLangId',
    'SPDKL_DefaultLocation', 'SpeechVoicePriority', 'SVSFNLPMask',
    'DISPID_SVResume', 'SpInprocRecognizer', 'SRAInterpreter',
    ...
    'SpeechRecognizerState', 'DISPID_SBSSeek', 'ISpVoice',
    'SpeechPartOfSpeech', 'DISPID_SRState', 'DISPID_SRGetRecognizers',
    'SITooQuiet', 'SITooLoud', 'SAFT16kHz16BitMono', 'eLEXTYPE_USER',
    'SpeechRecoEvents', 'SAFTExtendedAudioFormat',
    ...
    'DISPID_SDKDeleteKey', 'DISPID_SGRName', 'DISPID_SpeechVoice',
    'SDKLCurrentUser', 'SAFT16kHz16BitStereo',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVESentenceBoundary',
    'eLEXTYPE_MORPHOLOGY', 'ISpeechPhraseElements', 'ISpPhraseAlt',
    'ISpRecognizer', 'SPEI_TTS_BOOKMARK', 'DISPID_SOTsItem',
    'DISPID_SRGCommit', 'SVF_None', 'SAFT22kHz8BitStereo',
    'SGPronounciation', 'DISPID_SRCBookmark',
    'DISPID_SpeechLexiconProns', 'DISPID_SPERetainedStreamOffset',
    'SAFT12kHz8BitStereo', 'DISPID_SVSyncronousSpeakTimeout',
    'SPPS_NotOverriden', 'SPEI_VISEME', 'DISPID_SPARecoResult',
    'SAFT32kHz8BitStereo', 'DISPID_SPPId', 'ISpRecoContext2',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SASCurrentSeekPosition',
    'ISpeechWaveFormatEx', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SRTExtendableParse', 'ISpEventSource', 'SRTSMLTimeout',
    'DISPID_SRAudioInputStream', 'SpeechCategoryRecognizers',
    'DISPID_SASState', 'SVSFlagsAsync',
    'DISPID_SASCurrentDevicePosition', 'SpeechRegistryUserRoot',
    'SPEI_SR_PRIVATE', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SASFreeBufferSpace', 'SDTPronunciation', 'SPRST_INACTIVE',
    'SPSLMA', 'DISPID_SOTRemove', 'SAFT24kHz16BitStereo',
    'ISpeechMemoryStream', 'eLEXTYPE_PRIVATE14', 'DISPID_SOTCSetId',
    'SVSFParseAutodetect', 'ISpeechAudioFormat',
    'DISPID_SPRFirstElement', 'SPEI_VOICE_CHANGE',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SPAStartElementInResult',
    'SGSDisabled', 'DISPID_SpeechObjectTokens', 'SVPAlert',
    'SPEI_MIN_SR', 'SAFTADPCM_22kHzStereo', 'eLEXTYPE_RESERVED10',
    'DISPID_SPIStartTime', 'DISPID_SMSADeviceId',
    'SSSPTRelativeToCurrentPosition', 'SPWT_PRONUNCIATION',
    'DISPID_SVSInputWordPosition', 'SPCATEGORYTYPE', 'SPEVENT',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpResourceManager',
    'SSFMOpenForRead', 'DISPID_SRCCreateGrammar',
    'DISPID_SpeechRecoContextEvents', 'SVSFParseSsml', 'SWTAdded',
    'SPEI_RECO_STATE_CHANGE', 'SpeechDisplayAttributes',
    'SREAdaptation', 'SVEBookmark', 'SAFTCCITT_uLaw_11kHzMono',
    'SpeechLexiconType', 'ISpPhrase', 'SPFM_OPEN_READONLY',
    'SPWAVEFORMATTYPE', 'SP_VISEME_6', 'DISPID_SGRId',
    'ISpRecoResult', 'ISpObjectToken', 'SpUnCompressedLexicon',
    'SSTTTextBuffer', 'DISPID_SRIsShared', 'SVP_1',
    'SpeechCategoryAppLexicons', 'DISPID_SPEDisplayText',
    'SAFTADPCM_44kHzMono', 'SPSNotOverriden', 'DISPID_SVEStreamEnd',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPIElements',
    'DISPID_SPERetainedSizeBytes', 'ISpRecoContext', 'SREPrivate',
    'DISPID_SPRText', '_RemotableHandle', 'DISPID_SLWType',
    'SpObjectTokenCategory', 'SPTEXTSELECTIONINFO',
    'SAFT32kHz8BitMono', 'ISpeechRecoResultTimes',
    'DISPID_SpeechLexiconPronunciation', 'SGRSTTEpsilon',
    'SPGRAMMARWORDTYPE', 'DISPID_SRCreateRecoContext',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVEBookmark',
    'SECFEmulateResult', 'SpeechTokenKeyUI',
    ...
    'DISPID_SRCEEnginePrivate', 'SPXMLRESULTOPTIONS',
    'DISPID_SVGetVoices', '_SPAUDIOSTATE', 'DISPID_SOTCategory',
    'DISPID_SVSCurrentStreamNumber', 'SPSERIALIZEDPHRASE',
    'SpeechEmulationCompareFlags', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPID_SPAs_NewEnum', 'DISPID_SAVolume', 'DISPID_SRRecognizer',
    'LONG_PTR', 'SAFTADPCM_8kHzMono', 'DISPID_SGRsCommit',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SRCERequestUI',
    'STSF_LocalAppData', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SpeechPropertyAdaptationOn', 'DISPID_SLPsCount',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SpeechCustomStream',
    'SpeechCategoryAudioOut', 'SpeechTokenKeyAttributes',
    'SVEVoiceChange', 'SVEAudioLevel', 'SGDSActiveUserDelimited',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SDKSetBinaryValue', 'DISPID_SPPConfidence',
    'SECFNoSpecialChars', 'SpeechDiscardType', 'eLEXTYPE_PRIVATE19',
    'SITooSlow', 'DISPID_SPRuleChildren',
    'DISPID_SpeechPhraseAlternates', 'SPSNoun', 'DISPID_SVStatus',
    'SpeechPropertyResponseSpeed', 'SRSActive',
    'DISPID_SGRSTNextState', 'ISpeechPhraseInfoBuilder',
    'SPEI_RESERVED3', 'SRATopLevel', 'SVP_21', 'DISPID_SPIGrammarId',
    'DISPID_SVWaitUntilDone', 'SPBO_TIME_UNITS',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SLRemovePronunciation',
    'SVESentenceBoundary', 'SpeechInterference',
    'SpeechEngineProperties', 'SAFTADPCM_11kHzStereo', 'ISpeechAudio',
    'SECLowConfidence', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SVSPhonemeId', 'DISPID_SLWWord', 'DISPID_SRRTLength',
    'SPEI_START_SR_STREAM', 'SPPROPERTYINFO',
    'Speech_Max_Word_Length', 'SFTInput',
    'DISPID_SOTMatchesAttributes', 'DISPID_SBSWrite',
    'SpeechRetainedAudioOptions', 'SRESoundEnd', 'SAFT16kHz8BitMono',
    'SDA_Consume_Leading_Spaces', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SGRAddResource', 'DISPID_SPPsItem', 'SpeechLoadOption',
    'SPEI_RECOGNITION', 'SPPHRASEELEMENT', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechPhraseProperties', 'ISpeechLexiconPronunciations',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SPRsItem',
    'SAFT48kHz16BitMono', 'SPRST_NUM_STATES', 'STCLocalServer',
    'SREInterference', 'DISPID_SGRsCommitAndSave', 'DISPID_SRGReset',
    'DISPID_SVEAudioLevel', 'DISPID_SRStatus', 'SAFT12kHz16BitStereo',
    'DISPID_SpeechGrammarRules', 'DISPID_SPRuleConfidence',
    'eLEXTYPE_PRIVATE20', 'DISPID_SGRsAdd', 'SAFT11kHz8BitStereo',
    'SRTAutopause', 'SP_VISEME_3', 'DISPID_SVAudioOutput',
    'DISPID_SOTDisplayUI', 'SpeechEngineConfidence',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SRCSetAdaptationData', 'SVP_17',
    'ISpGrammarBuilder', 'DISPID_SDKEnumValues',
    'SPEI_SR_AUDIO_LEVEL', 'SDTReplacement', 'SpNullPhoneConverter',
    'SAFTCCITT_uLaw_44kHzMono', 'eLEXTYPE_PRIVATE5',
    'DISPID_SLWsItem', 'DISPID_SRRSetTextFeedback', 'DISPID_SBSRead',
    'DISPID_SABIMinNotification', 'SPEI_HYPOTHESIS',
    'SPCT_SUB_COMMAND', 'SPCT_SLEEP', 'DISPID_SPRs_NewEnum',
    'DISPID_SVRate', 'ISpeechLexiconWord', 'SAFT8kHz16BitStereo',
    'SAFT11kHz8BitMono', 'SpeechRuleAttributes', 'SpeechAudioState',
    'DISPID_SVSpeakStream', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechBookmarkOptions', 'DISPID_SpeechPhraseReplacement',
    'SDTRule', 'ISpLexicon', 'ISpShortcut', 'SPEI_RESERVED2',
    'ISpeechObjectToken', 'SPRST_INACTIVE_WITH_PURGE', 'SPSModifier',
    'ISpeechXMLRecoResult', 'SDKLLocalMachine', 'SP_VISEME_21',
    'SPRST_ACTIVE', 'SpeechWordPronounceable', 'SVP_12', 'SRAImport',
    'ISpeechLexiconPronunciation', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SGRSTPropertyId', 'DISPID_SVAlertBoundary',
    'DISPID_SRGState', 'DISPID_SGRSTPropertyValue',
    'DISPID_SVEPhoneme', 'SPEI_TTS_AUDIO_LEVEL', 'SP_VISEME_16',
    'DISPID_SOTGetDescription', 'ISpRecoGrammar2',
    'SPFM_CREATE_ALWAYS', 'ISpeechGrammarRuleStateTransition',
    'SECFIgnoreCase', 'SPVPRIORITY', 'SAFT12kHz16BitMono',
    'DISPID_SpeechMemoryStream', 'SPPS_Modifier',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SVSInputWordLength',
    '__MIDL_IWinTypes_0009', 'DISPID_SPISaveToMemory',
    'DISPID_SVEVoiceChange', 'SAFTADPCM_11kHzMono',
    'DISPID_SVSLastBookmarkId', 'SpeechVoiceEvents',
    'DISPID_SGRSAddRuleTransition', 'ISpeechObjectTokens',
    'IEnumString', 'SPSERIALIZEDRESULT', 'DISPID_SRGDictationUnload',
    'ISpeechBaseStream', 'SpStream', 'DISPID_SpeechPhraseRule',
    'ISpObjectTokenCategory', 'DISPID_SWFEBitsPerSample',
    'DISPID_SOTCEnumerateTokens', 'SpeechAudioFormatType',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SRCEStartStream',
    'DISPID_SRGetPropertyNumber', 'SPADAPTATIONRELEVANCE',
    'SVEPhoneme', 'SP_VISEME_7',
    'SpeechPropertyNormalConfidenceThreshold',
    'SpeechCategoryPhoneConverters', 'SPAUDIOOPTIONS',
    'ISpRecognizer2', 'SP_VISEME_17',
    'DISPID_SPANumberOfElementsInResult', 'SECFDefault',
    'SSSPTRelativeToEnd', 'SPLOADOPTIONS', 'SPEI_MIN_TTS',
    'SGRSTTWildcard', 'IEnumSpObjectTokens', 'SGDSInactive',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SOTId',
    'DISPID_SpeechVoiceEvent', 'SPCT_COMMAND', 'SPPHRASEREPLACEMENT',
    'SSSPTRelativeToStart', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SRProfile', 'SPEI_RESERVED1', 'SAFTNoAssignedFormat',
    'SVP_16', 'DISPID_SPRsCount', 'DISPID_SPAsCount',
    'DISPID_SMSAMMHandle', 'SPFM_CREATE', 'ISpeechVoice',
    'ISpeechRecoGrammar', 'ISpNotifySource', 'SAFT8kHz16BitMono',
    'SpeechStreamSeekPositionType', 'tagSPPROPERTYINFO', 'SPWF_INPUT',
    'ISpeechRecoResult2', 'ISpeechPhraseElement',
    'SREPropertyStringChange', 'SPVISEMES', 'SSTTDictation', 'SVP_19',
    'SPLEXICONTYPE', 'eLEXTYPE_PRIVATE10', 'SpLexicon',
    'SpeechRecoContextState', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRCEEndStream', 'SVP_7', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPEPronunciation', 'SPXRO_SML',
    'IInternetSecurityMgrSite', 'SPCONTEXTSTATE',
    'DISPID_SRGetFormat', 'SVEPrivate', 'DISPID_SLPPhoneIds',
    'DISPID_SREmulateRecognition', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRCState', 'SREStreamEnd', 'eLEXTYPE_USER_SHORTCUT',
    'SWPKnownWordPronounceable', 'SRARoot', 'DISPID_SRGDictationLoad',
    'DISPID_SpeechBaseStream', 'SVSFIsNotXML', 'SASPause',
    'SDA_Two_Trailing_Spaces', 'SVP_13', 'SPCS_ENABLED',
    'ISpRecoGrammar', 'SPEI_PHRASE_START', 'DISPID_SLPLangId',
    'DISPID_SLPType', 'SPSHORTCUTPAIR', 'DISPID_SOTDataKey',
    'DISPID_SGRsFindRule', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SRGRecoContext', 'Speech_Default_Weight', 'SpFileStream',
    'SASClosed', 'SVSFIsFilename', 'SVP_3', 'DISPID_SGRsItem',
    'SAFT11kHz16BitStereo', 'SpeechAllElements',
    'DISPID_SpeechPhoneConverter', 'SPAO_NONE', 'SRERequestUI',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SRSSupportedLanguages',
    'DISPID_SRRAudioFormat', 'DISPID_SWFEExtraData',
    'SpSharedRecoContext', 'SpeechAddRemoveWord',
    'ISpeechAudioStatus', 'SAFT8kHz8BitStereo', 'SREBookmark',
    'DISPID_SpeechAudioFormat', 'DISPID_SRCEInterference',
    'SAFT48kHz8BitStereo', 'DISPID_SOTGetAttribute', 'SPRULE',
    'DISPID_SOTCDefault', 'SAFT22kHz16BitMono',
    'SpeechAudioProperties', 'DISPID_SpeechRecoContext',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechMMSysAudio',
    'SVEAllEvents', 'DISPID_SDKSetStringValue',
    'SVSFPurgeBeforeSpeak', 'ISpNotifyTranslator',
    'DISPID_SMSSetData', 'SREPhraseStart', 'SPBOOKMARKOPTIONS',
    'DISPID_SOTSetId', 'SPRS_INACTIVE', 'ISpeechAudioBufferInfo',
    'SPAUDIOBUFFERINFO', 'SPDKL_LocalMachine', 'SPSFunction',
    'SREAudioLevel', 'ISpPhoneticAlphabetConverter',
    'Speech_StreamPos_Asap', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpeechRecognizer', 'SVP_0', 'DISPID_SABIBufferSize',
    'tagSPTEXTSELECTIONINFO', 'SDTProperty',
    'DISPID_SRRTOffsetFromStart', 'SVEStartInputStream',
    'SP_VISEME_13', 'DISPID_SPERequiredConfidence', 'ISpRecoCategory',
    'SPRULESTATE', 'SpeechCategoryAudioIn', 'SECFIgnoreWidth',
    'eLEXTYPE_PRIVATE3', 'DISPID_SPPs_NewEnum', 'SPEI_SR_BOOKMARK',
    'SVEWordBoundary', 'DISPID_SpeechRecoResult2',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SpeechRecoResultTimes', 'SpSharedRecognizer',
    'DISPID_SRCPause', 'DISPID_SRGetPropertyString', 'SVP_2',
    'SPEVENTENUM', 'DISPID_SOTCreateInstance', 'STCAll',
    'DISPID_SAFGetWaveFormatEx', 'SBOPause',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechTokenIdUserLexicon',
    'SDTLexicalForm', 'DISPID_SDKEnumKeys', 'DISPID_SPRules_NewEnum',
    'DISPID_SRGIsPronounceable', 'DISPID_SRRRecoContext',
    'ISpDataKey', 'SAFTCCITT_ALaw_8kHzMono', 'SpCustomStream',
    'eLEXTYPE_PRIVATE12', 'SpWaveFormatEx', 'DISPID_SpeechDataKey',
    'SPPHRASERULE', 'DISPID_SOTIsUISupported', 'DISPID_SPCIdToPhone',
    'SPEI_SR_RETAINEDAUDIO', 'SPVPRI_ALERT', 'SPEI_MAX_TTS',
    'SpeechRegistryLocalMachineRoot', 'ISpeechDataKey',
    'IInternetSecurityManager', 'ISpeechPhoneConverter',
    'DISPID_SPIProperties', 'DISPID_SPCLangId', 'UINT_PTR',
    'SPSHORTCUTPAIRLIST', 'SpAudioFormat', 'SVEViseme',
    'SPVPRI_NORMAL', 'SPEI_TTS_PRIVATE', 'SGRSTTWord',
    'DISPID_SPPNumberOfElements', 'SpeechVoiceCategoryTTSRate',
    'SP_VISEME_0', 'DISPID_SPPChildren', 'DISPID_SPEs_NewEnum',
    'SGRSTTTextBuffer', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SRGCmdLoadFromResource', 'SpeechTokenShellFolder',
    'DISPID_SDKDeleteValue', 'SPSVerb', 'SRTReSent',
    'DISPID_SGRsDynamic', 'DISPID_SVDisplayUI',
    'SPEI_PROPERTY_STRING_CHANGE', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFTText', 'SPSInterjection', 'DISPID_SRCESoundEnd', 'SLTApp',
    'SLTUser', 'DISPID_SLGetWords', 'DISPIDSPTSI_ActiveLength',
    'SPSTREAMFORMATTYPE', 'SBONone', 'tagSTATSTG',
    'SAFTGSM610_8kHzMono', 'SWPUnknownWordUnpronounceable',
    'DISPID_SCSBaseStream', 'DISPID_SRSNumberOfActiveRules',
    'SpeechVoiceSpeakFlags', 'DISPID_SPRulesCount',
    'SPWORDPRONUNCIATION', 'SpMMAudioIn', 'ISpeechLexicon',
    'SPCT_DICTATION', 'SPDKL_CurrentConfig', 'SWTDeleted',
    'SPGRAMMARSTATE', 'SPPS_SuppressWord', 'SPLO_STATIC',
    'SpeechAudioVolume', 'SVSFDefault', 'DISPID_SPRuleFirstElement',
    'SINoSignal', 'SPAUDIOSTATUS', 'ISpeechPhraseProperties',
    'SPINTERFERENCE_NONE', 'DISPID_SRGRules', 'SPEI_INTERFERENCE',
    'SVF_Emphasis', 'SECNormalConfidence', 'SpeechCategoryVoices',
    'DISPID_SRRPhraseInfo', 'SPFM_OPEN_READWRITE', 'SPPARTOFSPEECH',
    'SpShortcut', 'eLEXTYPE_PRIVATE6',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPPS_Noun',
    'DISPID_SADefaultFormat', 'SPEI_START_INPUT_STREAM',
    'DISPID_SFSClose', 'DISPID_SABIEventBias',
    'ISpStreamFormatConverter', 'DISPID_SGRSTPropertyName',
    'DISPID_SDKSetLongValue', 'DISPID_SpeechXMLRecoResult',
    'SpeechVisemeFeature', 'SVP_14', 'SPINTERFERENCE_NOSIGNAL',
    'SRSInactive', 'SPWF_SRENGINE', 'DISPID_SRCRecognizer',
    'DISPID_SRCCreateResultFromMemory',
    'DISPID_SpeechPhraseReplacements', 'SPAR_High',
    'SpeechGrammarTagUnlimitedDictation', 'SPRECORESULTTIMES',
    'ISpeechResourceLoader', 'SRTEmulated', 'DISPID_SRAudioInput',
    'DISPID_SVEWord', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SDKGetlongValue', 'SPSHT_EMAIL', 'SVSFNLPSpeakPunc',
    'SECHighConfidence', 'DISPID_SpeechObjectTokenCategory',
    'SpVoice', 'SPEI_MAX_SR', 'DISPID_SGRSTsItem',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRGDictationSetState',
    'SRSEDone', 'SpeechUserTraining', 'DISPID_SABufferInfo',
    'DISPID_SpeechPhraseRules', 'DISPID_SGRSTRule',
    'DISPID_SWFEFormatTag', 'SpMemoryStream', 'SPPS_RESERVED2',
    'SP_VISEME_1', 'DISPID_SRSClsidEngine', 'SVSFParseSapi',
    'DISPID_SASetState', 'SAFTCCITT_ALaw_11kHzStereo', 'SLOStatic',
    'SWPUnknownWordPronounceable', 'eLEXTYPE_RESERVED4',
    'SPDATAKEYLOCATION', 'DISPID_SPIGetDisplayAttributes', 'SVP_4',
    'SVSFParseMask', 'DISPID_SPIEngineId',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPEI_UNDEFINED', 'SAFTDefault',
    'ISpeechRecoContext', 'DISPID_SpeechPhraseInfo',
    'SpPhoneticAlphabetConverter', 'SINoise', 'DISPID_SOTsCount',
    'SPVOICESTATUS', 'DISPID_SAFSetWaveFormatEx',
    'SAFT11kHz16BitMono', 'SpCompressedLexicon', 'DISPID_SLPSymbolic',
    'SAFTGSM610_11kHzMono', 'SDTAlternates', 'DISPID_SRRSaveToMemory',
    'DISPID_SVSLastBookmark', 'SPSHT_Unknown', 'SPEVENTSOURCEINFO',
    'SPRS_ACTIVE', 'ISpeechTextSelectionInformation', 'SP_VISEME_20',
    'STCRemoteServer', 'SVP_9', 'SAFTGSM610_44kHzMono', 'SP_VISEME_4',
    'ISpeechPhraseRules', 'SRADefaultToActive', 'SPPS_Interjection',
    'SPWORD', 'DISPID_SPPName', 'ISpeechMMSysAudio',
    'DISPID_SABufferNotifySize', 'DISPID_SGRSTsCount',
    'eLEXTYPE_PRIVATE8', 'DISPID_SRRSpeakAudio', 'IStream',
    'STSF_AppData', 'ISpRecognizer3', 'eLEXTYPE_PRIVATE11',
    'ISpeechRecoResult', 'eLEXTYPE_RESERVED8',
    'DISPID_SpeechLexiconWords', 'DISPID_SPRuleName',
    'SAFT24kHz8BitStereo', 'SRSInactiveWithPurge', 'SPAS_PAUSE',
    'DISPID_SPPBRestorePhraseFromMemory', 'SGDSActiveWithAutoPause',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRRTStreamTime',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPRDisplayAttributes'
>>>>>>> roko1
]

_check_version('1.1.14', 1602449742.861658)
